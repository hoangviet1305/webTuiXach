...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/assets/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/assets/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/assets/vendors/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/assets/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/assets/vendors/owl-carousel-2/owl.carousel.min.css">
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/css/assets/vendors/owl-carousel-2/owl.theme.default.min.css">
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/css/assets/images/favicon.png"/>
...
<!-- inject:js -->
<script src="${pageContext.request.contextPath}/css/assets/js/off-canvas.js"></script>
<script src="${pageContext.request.contextPath}/css/assets/js/hoverable-collapse.js"></script>
<script src="${pageContext.request.contextPath}/css/assets/js/misc.js"></script>
<script src="${pageContext.request.contextPath}/css/assets/js/settings.js"></script>
<script src="${pageContext.request.contextPath}/css/assets/js/todolist.js"></script>
<!-- endinject -->
<!-- Custom js for this page -->
<script src="${pageContext.request.contextPath}/css/assets/js/dashboard.js"></script>
<!-- End custom js for this page -->
<rapid:block name="scripPath"></rapid:block>
